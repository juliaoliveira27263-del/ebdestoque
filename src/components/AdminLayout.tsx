      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-dark-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white font-bold text-sm">EBD Petrolina</h1>
        ...
        <div className="p-4 border-t border-dark-800">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-dark-300 hover:bg-dark-800 hover:text-white transition-colors"
          >
            <LogOut size={16} />
            Sair da conta
          </button>
