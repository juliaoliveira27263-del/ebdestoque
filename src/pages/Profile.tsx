  ...
  return (
    <div className="p-4 lg:p-6 max-w-2xl mx-auto space-y-4">
      <div>
        ...
        <p className="text-dark-400 text-sm mt-1">Gerencie suas informações</p>
      </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-dark-300 text-sm">{roleLabels[profile?.role ?? ''] ?? ''}</span>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" value={user?.email ?? ''} disabled className="input pl-10 opacity-50" />
            </div>
            <p className="text-dark-400 text-xs mt-1">O e-mail não pode ser alterado</p>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="input pl-10" placeholder="(00) 00000-0000" />
            </div>
          </div>
          ...
          {success && (
            <div className="p-3 rounded-lg bg-success-500/10 border border-success-500/30 text-success-500 text-sm">
